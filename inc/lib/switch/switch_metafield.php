...
{
    wp_enqueue_style('cmb2_switch-css', plugin_dir_url(__FILE__) . '/switch_metafield.css', false, '1.0.0');
    wp_enqueue_script('cmb2_switch-js', plugin_dir_url(__FILE__) . '/switch_metafield.js', '', '1.0.0', true);
}
